...
function weierstrass(curveDef) {
  ...
  function prepSig(msgHash, privateKey, opts = defaultSigOpts) {
    ...
    if (ent != null && ent !== false) {
      const e3 = ent === true ? randomBytes3(Fp2.BYTES) : ent;
...
function getHash(hash) {
  return {
    hash,
    hmac: (key, ...msgs) => hmac2(hash, key, concatBytes(...msgs)),
    randomBytes
  };
}
...
var getMasterKeyFromSeed = (seed) => {
  const h = hmac2.create(sha5122, ED25519_CURVE);
...
*/
//# sourceMappingURL=chunk-XRJFLBSC.js.map
